...
<head>
    ...
    <meta property="og:image" content="<?= SITE_URL ?>/assets/img/og-image.svg">
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="630">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?= $pageTitle ?? seoTitle(SITE_TAGLINE) ?>">
    <meta name="twitter:description" content="<?= $pageDescription ?? seoDescription(SITE_DESCRIPTION) ?>">
    <meta name="twitter:image" content="<?= SITE_URL ?>/assets/img/og-image.svg">
    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-cloak x-transition
                            ...
                            <div class="px-4 py-2 text-xs font-semibold text-gray-400 uppercase tracking-wider">Destinations populaires</div>
                    ...
                    <a href="/#services" class="text-gray-700 hover:text-primary-600 font-medium">Hébergements</a>
        ...
        <div x-show="mobileMenu" x-cloak x-transition class="md:hidden border-t border-gray-100">
            <div class="px-4 py-4 space-y-3">
                <a href="/#regions" class="block py-2 text-gray-700 font-medium">Destinations</a>
                <a href="/#services" class="block py-2 text-gray-700 font-medium">Hébergements</a>
