<?php
/**
 * Page Région - Annuaire Chambres d'Hôtes
 * URL: /{region}/
 */
...
$pageDescription = seoDescription('Hébergements en région ' . $region['nom'] . '. ' . $region['departements_count'] . ' départements couverts. Chambres d\'hôtes, gîtes et hôtels de charme.');
...
$regionStats = getRegionStats($region);
...
<section class="relative py-16 lg:py-20 overflow-hidden" style="min-height: 320px;">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            <?= generateRegionHero($region, $regionStats) ?>
        </p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900">
                Hébergements par département
            </h2>
            <p class="text-gray-600 mt-2">
                Découvrez les hébergements par département en <?= e($region['nom']) ?>
            </p>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl p-8 border border-gray-200">
            <h2 class="text-2xl font-bold text-gray-900 mb-4">
                Trouver un hébergement en <?= e($region['nom']) ?>
            </h2>
            <div class="prose prose-gray max-w-none">
                <?= generateRegionContent($region, $regionStats) ?>
            </div>
        </div>
    </div>
</section>
