<?php
/**
 * Page Politique de Confidentialité - Annuaire Chambres d'Hôtes
...
$pageDescription = seoDescription('Politique de confidentialité du site annuaire-chambres-hotes.fr. Découvrez comment nous collectons, utilisons et protégeons vos données personnelles.');
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="prose prose-lg prose-gray max-w-none">
            <p class="text-gray-600 mb-8">
                La protection de vos données personnelles est une priorité pour annuaire-chambres-hotes.fr.
            ...
            <ul class="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li><strong>Données relatives à votre recherche :</strong> informations sur votre recherche d'hébergement (destination, dates, nombre de personnes)</li>
            </ul>
            <p>Ces informations sont collectées lorsque vous :</p>
            <ul class="list-disc pl-6 space-y-2 text-gray-700">
                <li>Effectuez une recherche d'hébergement</li>
            ...
            <ul class="list-disc pl-6 space-y-2 text-gray-700">
                <li>Vous aider à trouver les hébergements correspondant à vos critères</li>
                <li>Personnaliser votre expérience et répondre à vos besoins</li>
                <li>Améliorer notre site web et nos services</li>
                <li>Vous envoyer des informations relatives à votre recherche</li>
            ...
            <ul class="list-disc pl-6 space-y-2 text-gray-700">
                <li><strong>Hébergeurs partenaires :</strong> lorsque vous effectuez une demande de contact, vos coordonnées peuvent être transmises aux hébergeurs concernés</li>
            ...
            <p>
                Pour exercer ces droits, contactez-nous à : <strong>contact@annuaire-chambres-hotes.fr</strong>
            </p>
            <p>
            ...
            <ul class="list-disc pl-6 space-y-2 text-gray-700">
                <li>Données de recherche d'hébergement : 3 ans à compter de la dernière interaction</li>
            ...
            <ul class="list-disc pl-6 space-y-2 text-gray-700">
                <li><strong>Email :</strong> contact@annuaire-chambres-hotes.fr</li>
