<?php
/**
 * Page Mentions Légales - Annuaire Chambres d'Hôtes
...
$pageDescription = seoDescription('Mentions légales du site annuaire-chambres-hotes.fr. Informations sur l\'éditeur, l\'hébergeur, la propriété intellectuelle et les conditions d\'utilisation.');
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="prose prose-lg prose-gray max-w-none">
            <p class="text-gray-600 mb-8">
                ...
                dite L.C.E.N., nous portons à la connaissance des utilisateurs et visiteurs du site annuaire-chambres-hotes.fr les informations suivantes :
            </p>

            <h2 class="text-2xl font-bold text-gray-900 mt-10 mb-4">1. Édition du site</h2>
            <p>Le site <strong>annuaire-chambres-hotes.fr</strong> est édité par :</p>
            <ul class="list-disc pl-6 space-y-2 text-gray-700">
                <li><strong>Nom du site :</strong> <?= SITE_NAME ?></li>
                <li><strong>URL :</strong> https://annuaire-chambres-hotes.fr</li>
                <li><strong>Email de contact :</strong> contact@annuaire-chambres-hotes.fr</li>
            ...
            <p>Le site annuaire-chambres-hotes.fr est hébergé par :</p>
            <ul class="list-disc pl-6 space-y-2 text-gray-700">
            ...
            <p>
                L'ensemble du contenu du site annuaire-chambres-hotes.fr (textes, images, graphismes, logo, icônes, sons, logiciels, etc.)
            ...
            <p>
                Le site annuaire-chambres-hotes.fr ne pourra être tenu responsable des dommages directs et indirects causés au matériel de l'utilisateur,
            ...
            <p>
                Le site annuaire-chambres-hotes.fr ne pourra également être tenu responsable des dommages indirects (tels par exemple qu'une perte de marché
            ...
            <p>
                ...
                merci de bien vouloir le signaler par email à contact@annuaire-chambres-hotes.fr.
            </p>
            ...
            <p>
                Pour exercer ces droits, vous pouvez nous contacter à l'adresse email suivante : <strong>contact@annuaire-chambres-hotes.fr</strong>
            </p>
            <p>
            ...
            <p>
                Le site annuaire-chambres-hotes.fr peut être amené à vous demander l'acceptation des cookies pour des besoins de statistiques et d'affichage.
            ...
            <p>
                Le site annuaire-chambres-hotes.fr peut contenir des liens hypertextes vers d'autres sites présents sur le réseau Internet.
                Les liens vers ces autres ressources vous font quitter le site annuaire-chambres-hotes.fr.
            </p>
            <p>
