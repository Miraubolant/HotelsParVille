<?php
/**
 * Fiche Hébergement - Annuaire Chambres d'Hôtes
...
// SEO
$pageTitle = seoTitle($artisan['nom'] . ' - Hébergement à ' . $ville['nom_standard']);
$pageDescription = seoDescription($artisan['nom'] . ', hébergement à ' . $ville['nom_standard'] . ' (' . $codePostal . '). ' . ($artisan['note'] ? 'Note : ' . $artisan['note'] . '/5. ' : '') . 'Découvrez cet hébergement pour votre séjour.');
                ...
                <div class="flex items-start space-x-4 mb-6">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-lg text-white/90">
                            Hébergement à <?= e($ville['nom_standard']) ?> (<?= e($codePostal) ?>)
                        </p>
                        <?php if ($artisan['type']): ?>
                    ...
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-white/70">Meilleurs prix</p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="font-semibold text-white">Réservation en ligne</p>
                                <p class="text-sm text-white/70">Simple et rapide</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="lg:grid lg:grid-cols-3 lg:gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <!-- Garanties -->
            <section class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6">
                ...
                <div class="grid sm:grid-cols-3 gap-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="font-medium text-gray-900">Hébergement vérifié</span>
                    </div>
                    <div class="flex items-center space-x-3">
                        <svg class="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <span class="font-medium text-gray-900">Qualité garantie</span>
                    </div>
                    <div class="flex items-center space-x-3">
                        <svg class="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                        </svg>
                        <span class="font-medium text-gray-900">Meilleurs prix</span>
                    </div>
                </div>
            </section>
            ...
            <section>
                <h2 class="text-xl font-bold text-gray-900 mb-6">
                    Autres hébergements à <?= e($ville['nom_standard']) ?>
                </h2>
                <div class="space-y-4">
        ...
        <aside class="lg:col-span-1 space-y-8 mt-12 lg:mt-0">
            <div class="lg:sticky lg:top-24">
                ...
                <div class="bg-gradient-to-br from-primary-600 to-primary-800 rounded-2xl p-6 shadow-xl text-center">
                    ...
                    <h3 class="text-xl font-bold text-white mb-2">Envie de réserver ?</h3>
                    <p class="text-primary-100 text-sm mb-4">
                        Découvrez les meilleurs hébergements de <?= e($ville['nom_standard']) ?>
                    </p>
                    <a href="#rechercher"
